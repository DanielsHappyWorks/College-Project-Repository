...
$localHostSiteFolderName      = "2DGamesCA1";

$localhostDatabaseName        = "CanvasGame";
...
$serverWebsiteName            = "students.dkit.ie/D00123456"; /* use this address if hosting website on the college students' website server */

$serverDatabaseName           = "D00123456";
$serverDatabaseHostAddress    = "mysql.comp.dkit.ie";         /* use this address if hosting database on the college computing department database server */
